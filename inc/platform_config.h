...
#define K_USER1_SFT					7	/* Bit1 */
#define K_USER2_SFT					1	/* Bit2 */
#define K_TAMPER_SFT				10  /* Bit3 */
#define K_WAKEUP_SFT				0   /* Bit0 */
...
#define LED_PORT_LED1				(GPIOG)
#define LED_PORT_LED2				(GPIOG)
#define LED_PORT_LED3				(GPIOG)
#define LED_PORT_LED4				(GPIOG)

#define LED_CLK_LED1				(RCC_AHB1Periph_GPIOG)
#define LED_CLK_LED2				(RCC_AHB1Periph_GPIOG)
#define LED_CLK_LED3				(RCC_AHB1Periph_GPIOG)
#define LED_CLK_LED4				(RCC_AHB1Periph_GPIOG)
