...
#define __SDIO_STM32F4_H	0x2300
...
Å@ "SDIO clock divider BYPASS mode may not work properly" and 
...
/** 
  ...
  * For STM32F40x/41x :48.00MHz(SDIOCLK MAX Value@SYSCLK168MHz)/(128+2) = 369kHz.
  * For STM32F42x/43x :51.43MHz(SDIOCLK MAX Value@SYSCLK180MHz)/(128+2) = 396kHz.
  */
...
/** 
  ...
  * For STM32F40x/41x :48.00MHz(SDIOCLK MAX Value@SYSCLK168MHz)/(0+2) = 24.00MHz.(16.00MHz for MMCv3.x)
  * For STM32F42x/43x :51.43MHz(SDIOCLK MAX Value@SYSCLK180MHz)/(0+2) = 25.72MHz.(17.14MHz for MMCv3.x)
  */
